...
@interface Maid_AdminObject : KrollCoverageObject {
#else
@interface Maid_AdminObject : KrollObject {
#endif
@private
...
extern NSString * Maid_Admin$ModuleRequireFormat;
