...
//@interface Maid_AdminObject : NSObject
//@end

@interface Maid_AdminObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Maid_AdminObject class]])
		{
			for (NSString *key in [[(Maid_AdminObject*)o modules] allKeys])
			{
