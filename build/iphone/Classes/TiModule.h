...
/**
 The base class for all Maid_Admin modules
 */
...
/**
 Maid_Admin Platform calls this method on startup.
 */
-(void)startup;

/**
 Maid_Admin Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Maid_Admin Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Maid_Admin Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Maid_Admin Platform calls this method on resume.
 @param sender The sender of the event.
 */
