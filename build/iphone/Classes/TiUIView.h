...
/**
 Base class for all Maid_Admin views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the Maid_Admin view hierarchy (such as wrapped iOS UIViews) was touched.
