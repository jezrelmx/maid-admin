...
// in simulator we redefine to format for Maid_Admin Developer console
...
{\
	NSString * exceptionName = [@"org.maid_admin." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.maid_admin";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIMaid_AdminNativeItemNone = -1, 
	UIMaid_AdminNativeItemSpinner = -2,
	UIMaid_AdminNativeItemProgressBar = -3,
	
	UIMaid_AdminNativeItemSlider = -4,
	UIMaid_AdminNativeItemSwitch = -5,
	UIMaid_AdminNativeItemMultiButton = -6,
	UIMaid_AdminNativeItemSegmented = -7,
	
	UIMaid_AdminNativeItemTextView = -8,
	UIMaid_AdminNativeItemTextField = -9,
	UIMaid_AdminNativeItemSearchBar = -10,
	
	UIMaid_AdminNativeItemPicker = -11,
	UIMaid_AdminNativeItemDatePicker = -12,
	
	UIMaid_AdminNativeItemInfoLight = -13,
	UIMaid_AdminNativeItemInfoDark = -14,
	
	UIMaid_AdminNativeItemDisclosure = -15,
	
	UIMaid_AdminNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all Maid_Admin instances of
